...
const Aside = ({user}) => {
  ...
  return (
    <aside className="relative group flex-col justify-center text-center gap-3 bg-white/5 backdrop-blur-md border border-white/20 shadow-lg h-full w-20 hover:w-60 rounded-r-[10px] transition-all duration-650 overflow-hidden">
        <section className="flex flex-col items-center justify-center text-center gap-5">

            <div className="mt-10 group flex justify-center items-center h-7 w-40 border rounded-2xl border-gray-300 hover:bg-gray-300 hover:cursor-pointer opacity-0 group-hover:opacity-100 transition-all duration-300 delay-200 whitespace-nowrap">
